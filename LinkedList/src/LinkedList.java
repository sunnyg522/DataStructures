...
/*****   Include the main() for testing and debugging  *****/
   ...
   public static void main(String[] args)
   {
      ...
      list.addFirst("F");
      //list.addTwin();
      System.out.println("Count: "+list.countLinks());
      //System.out.println("Count using rec :"+list.countUnsingRec());

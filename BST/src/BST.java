...
public class BST <T extends Comparable<T>> implements Iterable<T>
{
   ...
   {
	   System.out.println("Creatign a new Binay tree.");
      Integer[] a = {2,5,1,7,4};
      BST<Integer> bst = new BST<Integer>();
      for(Integer n : a) bst.insert(n);

      
      System.out.println("Printing the total of full nodes");
      System.out.println(bst.FullNodeCount());
      
      System.out.println("Counting number of leaf nodes");
   ...
   private int FullNodeCount(Node node)
   {
	   if(node==null)
		   ...
		   return (1+FullNodeCount(node.left)+FullNodeCount(node.right));
	   else 
		   return FullNodeCount(node.left)+FullNodeCount(node.right);
   }
/*****************************************************
*
*            INSERT
